...
public class DolarAPI {
    ...
    public static double getDolarBlueValue() {
        ...
        try {
            ...
            System.err.println("Error al obtener el valor del dólar blue de la API, se utilizará un default de $400 como valor: " + e.getMessage());
    ...
    public static void printDolarBlueValue() {
        try {
            double dolarBlueValue = getDolarBlueValue();
            System.out.println("Valor del dólar blue: " + dolarBlueValue);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
