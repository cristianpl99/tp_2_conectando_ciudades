...
public class ConnectingCitiesTest {
    ...
    public void testValidateCityParams() throws Exception {
      ...
      assertFalse(connectingCities.validateCityParams("Ushuaia", "Tierra del Fuego", -54.805890, -69.331392)); // Latitud fuera de rango
      assertFalse(connectingCities.validateCityParams("San Miguel de Tucumán", "Tucumán", -26.819819, -71.218904)); // Longitud fuera de rango 
      assertFalse(connectingCities.validateCityParams("Mendoza", "xxxxx", -32.890183, -68.844050)); // Provincia invalida
    }
